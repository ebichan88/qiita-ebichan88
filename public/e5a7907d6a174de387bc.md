---
title: 【DB2】SQLで文字列連結をしても何も出力されない場合の対処法
tags:
  - SQL
  - db2
private: false
...
SQLの文字列結合は便利ですが、値をうまく取り出せない場合もあります。

今回は以下のテーブル（`personal_information`）から、それぞれのレコードをカンマ区切りで出力する場合を例にして、値が取れないケースを紹介します。
